...
<main class="content">
    ...
    <a href="<?= BASE_URL ?>/admin/users/index.php" style="display: inline-block; margin-bottom: 15px; padding: 8px 12px; background-color: #ccc; color: #000; text-decoration: none; border-radius: 4px;">
        ← Back to Users List
    </a>
    <h2 style="text-align: center;">Add User</h2>

    <form id="addUser" style="max-width: 600px;">
...
$(document).ready(function () {
    ...
    form.on('submit', function (e) {
        ...
        $.ajax({
            url: '<?= BASE_URL . '/admin/php_files/sections/users/add.php' ?>',
            type: 'POST',
            data: form.serialize(),
            dataType: 'json',
